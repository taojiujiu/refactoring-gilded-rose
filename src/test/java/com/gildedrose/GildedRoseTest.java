...
public class GildedRoseTest {
    ...
    public void foo() {
        ...
        assertEquals("foo", gildedRose.roses.get(0).name);
        assertThat(gildedRose.roses.get(0).quality, is(4));
        assertThat(gildedRose.roses.get(0).sellIn, is(0));
    }
    ...
    public void should_quality_subtract_1_when_update_quality_given_normal_rose(){
        ...
        GildedRose gildedRose = new GildedRose(roses);
        gildedRose.updateQuality();
        assertEquals("normal rose", gildedRose.roses.get(0).name);
        assertThat(gildedRose.roses.get(0).quality, is(2));
    }
    ...
    public void should_sell_subtract_1_when_update_sell_given_normal_rose_concert_rose(){
        ...
        GildedRose gildedRose = new GildedRose(roses);
        gildedRose.updateQuality();
        assertEquals("normal", gildedRose.roses.get(0).name);
    ...
    public void should_quality_add_2__when_update_quality_given_Aged_Brie_concert_rose_and_sell_less_than_0_and_quality_less_than_49(){
        ...
        gildedRose.updateQuality();
        assertEquals("Aged Brie", gildedRose.roses.get(0).name);
        assertThat(gildedRose.roses.get(0).quality,is(46));
    }
